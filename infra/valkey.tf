resource "aws_elasticache_subnet_group" "valkey" {
  ...
  # CHANGED: Use the data source for private subnets
...
resource "aws_security_group" "valkey" {
  ...
  # CHANGED: Use the data source for VPC ID
  ...
  ingress {
    ...
    # CHANGED: Allow traffic from the entire VPC CIDR
    # (Fetching exact private subnet CIDRs from data sources is complex, 
    # and allowing the whole VPC is standard safe practice for internal caches)
